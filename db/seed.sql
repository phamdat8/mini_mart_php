...
insert into products(user_id, category_id, name, description, img_link, quantity, unit_type, price)
  values(1, 1, 'Táo', 'Vẫn còn trên cây','db/images/seed/product1.png', 10, 'Kg', 100000),
        ...
        (1, 1, 'Xoài', 'Chua lắm','db/images/seed/product3.jpg', 50, 'Kg', 40000),
        (1, 1, 'Mít', 'Mít !!!!','db/images/seed/product4.png', 10, 'Quả', 30000),
        (1, 1, 'Khế', 'Khế chua','db/images/seed/product5.jpg', 100, 'Quả', 5000);
insert into products(user_id, category_id, name, description, img_link, quantity, unit_type, price)
